...
def calculate_demographic_data(print_data=True):
    # Read data from file
    path_file = os.path.join(os.getcwd(),'data','adult.data.csv')
    ...
    mask = df['sex'] == 'Male'
    average_age_men = df[mask]['age'].mean().__round__(1)
    ...
    percentage_high_earners = (high_earners_by_country / total_people_by_country) * 100
    ...
    total_occupation_by_country = df[mask]['occupation'].value_counts()
    top_IN_occupation = total_occupation_by_country.idxmax()
